...
<head>
    ...
    <style>
        ...
        .side-section h3 { font-size: 0.85rem; margin-bottom: 8px; color: #6b7280; text-transform: uppercase; }
        ...
        h2 { margin: 0 0 15px 0; font-size: 1.1rem; border-left: 4px solid var(--primary); padding-left: 10px; }
...
def web_restore():
    ...
    if file:
        ...
        if "violation_records" not in bot.db: bot.db["violation_records"] = {}
        bot.save_data()
    return redirect('/')
